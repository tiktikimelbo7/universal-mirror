...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/b452f3285dbaf391f4c0b.jpg" type="image/jpg">
    <script
...
<body>
  <!--© MirLeechX-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/b452f3285dbaf391f4c0b.jpg"
          alt="logo"
        />
...
async def homepage(request):
    ...
    return web.Response(text="<h1>Congratulations! Your Bot Server is Up and Running.</h1>", content_type="text/html")
